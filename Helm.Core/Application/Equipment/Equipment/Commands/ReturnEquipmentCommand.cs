...
namespace Helm.Core.Application.Equipment.Equipment.Commands
{
    ...
    public class ReturnEquipmentCommandHandler : IRequestHandler<ReturnEquipmentCommand, GetOperationResult<EquipmentDTO>>
    {
        ...
        public ReturnEquipmentCommandHandler(IEquipmentRepository equipmentRepository, IUserRepository userRepository, IUserContext userContext, IValidator<RenameEquipmentCommand> validator, IMapper mapper)
        {
